...
import { Params } from "./module/types/berkingblog/params"
import { Post } from "./module/types/berkingblog/post"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: berkingblog.berkingblog initialized!')
