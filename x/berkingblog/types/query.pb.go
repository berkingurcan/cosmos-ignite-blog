...
// source: berkingblog/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36049904a01fdb, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36049904a01fdb, []int{1}
}
...
func (*QueryPostsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36049904a01fdb, []int{2}
}
...
func (*QueryPostsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb36049904a01fdb, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "berkingblog.berkingblog.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "berkingblog.berkingblog.QueryParamsResponse")
	proto.RegisterType((*QueryPostsRequest)(nil), "berkingblog.berkingblog.QueryPostsRequest")
	proto.RegisterType((*QueryPostsResponse)(nil), "berkingblog.berkingblog.QueryPostsResponse")
}

func init() { proto.RegisterFile("berkingblog/query.proto", fileDescriptor_fb36049904a01fdb) }

var fileDescriptor_fb36049904a01fdb = []byte{
	// 404 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/berkingblog.berkingblog.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Posts(ctx context.Context, in *QueryPostsRequest, opts ...grpc.CallOption) (*QueryPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/berkingblog.berkingblog.Query/Posts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/berkingblog.berkingblog.Query/Params",
	}
...
func _Query_Posts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/berkingblog.berkingblog.Query/Posts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "berkingblog.berkingblog.Query",
	...
	Metadata: "berkingblog/query.proto",
}
